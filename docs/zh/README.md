...
- **当前 1.0 版本在多实例部署下存在一系列已知问题，因此仅推荐单实例部署使用。**
- 如需了解具体问题及改造方案，请参考多实例分析文档：
  - 《[1.0版本多实例部署影响分析](1.0版本多实例部署影响分析.md)》
...
- [Keycloak配置指南.md](Keycloak配置指南.md) - Keycloak 配置说明
 - [1.0版本多实例部署影响分析.md](1.0版本多实例部署影响分析.md) - 1.0 版本多实例部署问题与升级方案
...
- [Feign服务间鉴权.md](Feign服务间鉴权.md) - 微服务通过 OpenFeign 互调时的 JWT 透传机制
